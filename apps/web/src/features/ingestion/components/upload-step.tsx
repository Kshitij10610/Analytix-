...
import type { UploadResponseDto } from "@/features/ingestion/types/ingestion";
...
interface UploadStepProps {
  companyId: string;
  onComplete: (response: UploadResponseDto) => void;
}

export function UploadStep({ companyId, onComplete }: UploadStepProps) {
