...
export type FinancialScale = "ONES" | "THOUSANDS" | "MILLIONS" | "BILLIONS";
export type FinancialDataSourceType = "MANUAL" | "CSV_IMPORT" | "API" | "AI_EXTRACTED";
...
export interface FinancialStatementWithLineItems extends FinancialStatement {
  lineItems: StatementLineItem[];
}

export interface CreateFinancialStatementPayload {
  type: FinancialStatementType;
  periodStart: string;
  periodEnd: string;
  fiscalYear: number;
...
export interface UpdateFinancialStatementPayload {
  type?: FinancialStatementType;
  periodStart?: string;
  periodEnd?: string;
  fiscalYear?: number;
